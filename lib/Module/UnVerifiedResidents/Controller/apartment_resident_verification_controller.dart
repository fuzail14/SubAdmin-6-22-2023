...
import 'package:societyadminapp/Module/UnVerifiedResidents/Model/Resident Model/ApartmentResidentModel.dart' as ApartmentResidentModel;
...
class ApartmentResidentVerificationController extends GetxController
{
  ...
  void onInit() {
    ...
    SelectedBuilding(Building(type:resident.building!.first.type,superadminid:resident.building!.first.superadminid,dynamicid: resident.building!.first.dynamicid,societyid: resident.building!.first.societyid,subadminid: resident.building!.first.subadminid,id: resident.building!.first.id,updatedAt: resident.building!.first.updatedAt,createdAt: resident.building!.first.createdAt,societybuildingname: resident.building!.first.societybuildingname));
    SelectedFloor(Floor(createdAt:resident.floor!.first.createdAt,updatedAt:resident.floor!.first.updatedAt,id: resident.floor!.first.id,name: resident.floor!.first.name,buildingid: resident.floor!.first.buildingid  ));
    SelectedApartment(Apartment(name: resident.apartment!.first.name,id: resident.apartment!.first.id,createdAt: resident.apartment!.first.createdAt,updatedAt: resident.apartment!.first.updatedAt,type: resident.apartment!.first.type,typeid: resident.apartment!.first.typeid,societybuildingfloorid: resident.apartment!.first.societybuildingfloorid));
